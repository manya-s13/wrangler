 ...
 */
 ...
 public enum TokenType implements Serializable {
    ...
    * This type is associated with byte size values with units (e.g., 10KB, 5MB).
    * Supported units: KB, MB, GB, TB, PB (case-insensitive).
    * @see ByteSize
    */
   BYTE_SIZE,
    ...
    * This type is associated with time duration values with units (e.g., 100ms, 5s).
    * Supported units: ns, μs, ms, s, min, hr, day (case-insensitive).
    * @see TimeDuration
    */
   TIME_DURATION
 }
